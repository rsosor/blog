...
import static com.rsosor.app.model.support.RsosoRConst.FILE_SEPARATOR;
...
public class RsosoRUtils {
    ...
    public static String normalizeUrl(@NonNull String originalUrl) {
        ...
        if (StringUtils.startsWithAny(originalUrl, URL_SEPARATOR, RsosoRConst.PROTOCOL_HTTPS,
                RsosoRConst.PROTOCOL_HTTP)
     ...
     */
    public static String getMatchineIP() {
