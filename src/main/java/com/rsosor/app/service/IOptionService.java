...
public interface IOptionService extends ICrudService<Option, Integer> {
     ...
     */
    @Transactional
    void saveProperty(@NonNull IPropertyEnum property, @Nullable String value);
     ...
     */
    @Transactional
    void saveProperties(@NonNull Map<? extends IPropertyEnum, String> properties);
     ...
     */
    @Nullable
    Object getByPropertyOfNullable(@NonNull IPropertyEnum property);
     ...
     */
    @NonNull
    Object getByPropertyOfNonNull(@NonNull IPropertyEnum property);
     ...
     */
    @NonNull
    Optional<Object> getByProperty(@NonNull IPropertyEnum property);
     ...
     */
    <T> Optional<T> getByProperty(@NonNull IPropertyEnum property, @NonNull Class<T> propertyType);
     ...
     * @return property value
     */
    <T> T getByPropertyOrDefault(@NonNull IPropertyEnum property, @NonNull Class<T> propertyType,
                                 T defaultValue);
     ...
     */
    @NonNull
    <T extends Enum<T>> Optional<T> getEnumByProperty(@NonNull IPropertyEnum property,
     ...
     */
    @Nullable
    <T extends Enum<T>> T getEnumByPropertyOrDefault(@NonNull IPropertyEnum property,
     ...
     */
    @NonNull
    <V, E extends Enum<E> & IValueEnum<V>> Optional<E> getValueEnumByProperty(
            @NonNull IPropertyEnum property,
     ...
     */
    @Nullable
    <V, E extends Enum<E> & IValueEnum<V>> E getValueEnumByPropertyOrDefault(
            @NonNull IPropertyEnum property,
